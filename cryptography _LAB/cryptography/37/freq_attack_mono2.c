/* Experiment 37: Automated letter-frequency attack on a Monoalphabetic
   Substitution cipher (same technique as Experiment 16, repeated here as
   its own standalone exercise per the lab manual). Ranks ciphertext
   symbols by frequency and maps them onto the standard English
   letter-frequency order (E T A O I N S H R D L U ...) to produce a
   first-pass candidate plaintext, refined manually using bigrams/trigrams. */
#include <stdio.h>
#include <string.h>
#include <ctype.h>
