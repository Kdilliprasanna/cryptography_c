/* Experiment 40: Automated letter-frequency attack on a Monoalphabetic
   Substitution cipher (same technique as Experiments 16 and 37, listed a
   third time in the lab manual). Ranks ciphertext symbols by frequency
   and maps them onto the standard English letter-frequency order to
   produce a first-pass candidate plaintext for manual refinement. */
#include <stdio.h>
#include <string.h>
#include <ctype.h>
