/* Experiment 15: Automated letter-frequency attack on an Additive (Caesar) cipher.
   Tries all 25 shifts, scores each candidate plaintext with a chi-squared style
   comparison against standard English letter frequencies, and prints the
   top-N most likely plaintexts (best score first). */
#include <stdio.h>
#include <string.h>
#include <ctype.h>
#include <math.h>
